...
class GraphTransformerPolicy(TMv2.TorchModelV2, nn.Module):
    def __init__(self, obs_space: gym.spaces.Space,
        ...
        print('================INIT GRAPH TRANSFORMER POLICY')
        # config
        ...
        # critic
        create_branch = utils.create_value_branch(
        ...
        print(f'create_branch {create_branch}')
        self._value_branch, self._value_branch_separate = create_branch
        print(f'================-------------- self._value_branch {self._value_branch}')
